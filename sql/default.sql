...
CREATE TABLE `album` (
  ...
  `date_add` datetime NOT NULL,
  `date_update` datetime NOT NULL,
  `pubkey` char(32) COLLATE utf8_czech_ci NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `rights` (`id`, `name`) VALUES (1, 'confirm'), (2, 'gallery'), (3, 'board');
...
INSERT INTO `roles` (`id`, `name`) VALUES (0,	'user'), (1,	'member'), (2,	'editor'), (3,	'admin');
...
CREATE TABLE `user` (
  ...
  `occupation` varchar(30) COLLATE utf8_czech_ci DEFAULT NULL,
  `city` varchar(30) COLLATE utf8_czech_ci DEFAULT NULL,
  `street` varchar(30) COLLATE utf8_czech_ci DEFAULT NULL,
  ...
  `phone` char(9) COLLATE utf8_czech_ci DEFAULT NULL,
  `phone2` char(9) COLLATE utf8_czech_ci DEFAULT NULL,
  ...
  `card_id` char(8) COLLATE 'utf8_czech_ci' NULL,
  `vzs_id` char(6) COLLATE 'utf8_czech_ci' NULL,
  `messenger_id` char(16) COLLATE 'utf8_czech_ci' NULL,
  `idoklad_id` varchar(16) COLLATE 'utf8_czech_ci' NULL,
